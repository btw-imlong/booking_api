...
import com.booking.booking_api.Dtos.Response.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> userNotFound(UsernameNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
    ...
    public ResponseEntity<ApiResponse<Object>> unauthorized(UnexpectedException ex) {
